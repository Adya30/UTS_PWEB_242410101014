<nav class="md:hidden bg-blue-600 text-white mt-5 mx-5 px-6 py-4 rounded-2xl shadow-md">
    ...
    <div id="mobile-menu" class="hidden absolute w-auto left-0 right-0 mt-2 mx-5">
        <div class="flex mt-4 bg-blue-600 rounded-xl p-4 flex-col gap-4">
            ...
            <a href="/dashboard" class="p-3 hover:bg-blue-500 rounded-lg"><i class="fa-solid fa-house"></i>  Dashboard</a>
            <a href="/profile" class="p-3 hover:bg-blue-500 rounded-lg"><i class="fa-solid fa-user"></i>  Profile</a>
            <a href="/pengelolaan" class="p-3 hover:bg-blue-500 rounded-lg"><i class="fa-solid fa-gear"></i>  Pengelolaan</a>
